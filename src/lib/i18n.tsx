...
const translations: Record<Language, Translations> = {
  en: {
    ...
    cancel: 'Cancel',
    confirm: 'Confirm',
    error_claiming_device: 'Error claiming device.',
    error_sending_command: 'Error sending command.',
    schedule_time_future: 'Schedule time must be in the future.',
    error_scheduling: 'Failed to schedule.',
    error_sharing: 'Failed to share.',
    confirm_cancel_schedule: 'Cancel this schedule?',
    confirm_remove_access: 'Remove access for {}?',
  ...
  ru: {
    ...
    cancel: 'Отмена',
    confirm: 'Подтвердить',
    error_claiming_device: 'Ошибка при регистрации устройства.',
    error_sending_command: 'Ошибка при отправке команды.',
    schedule_time_future: 'Время расписания должно быть в будущем.',
    error_scheduling: 'Не удалось создать расписание.',
    error_sharing: 'Не удалось предоставить доступ.',
    confirm_cancel_schedule: 'Отменить это расписание?',
    confirm_remove_access: 'Удалить доступ для {}?',
  ...
  uz: {
    ...
    cancel: 'Bekor qilish',
    confirm: 'Tasdiqlash',
    error_claiming_device: 'Qurilmani ro\'yxatdan o\'tkazishda xatolik.',
    error_sending_command: 'Buyruq yuborishda xatolik.',
    schedule_time_future: 'Jadval vaqti kelajakda bo\'lishi kerak.',
    error_scheduling: 'Jadval yaratib bo\'lmadi.',
    error_sharing: 'Ruxsat berib bo\'lmadi.',
    confirm_cancel_schedule: 'Ushbu jadval bekor qilinsinmi?',
    confirm_remove_access: '{} uchun ruxsatni olib tashlashni xohlaysizmi?',
