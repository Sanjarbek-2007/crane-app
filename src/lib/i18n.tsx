...
const translations: Record<Language, Translations> = {
  en: {
    ...
    opened: 'Opened',
    closed: 'Closed',
    device_not_responding: 'No response from the device yet - it may be offline or there could be a network issue. It might still catch up shortly.',
    device_stale_badge: 'Unresponsive',
    device_stale_transition: 'This device hasn\'t checked in for a while - its real position is uncertain. Choose an action below; it will take effect once it reconnects.',
    date: 'Date',
    time: 'Time',
  ...
  ru: {
    ...
    opened: 'Открыто',
    closed: 'Закрыто',
    device_not_responding: 'Устройство пока не отвечает - возможно, оно офлайн или есть проблема с сетью. Оно ещё может отреагировать чуть позже.',
    device_stale_badge: 'Не отвечает',
    device_stale_transition: 'Устройство давно не выходило на связь - его реальное положение неизвестно. Выберите действие ниже, оно применится, когда устройство снова подключится.',
    date: 'Дата',
    time: 'Время',
  ...
  uz: {
    ...
    opened: 'Ochildi',
    closed: 'Yopildi',
    device_not_responding: 'Qurilmadan hali javob yo\'q - u oflayn bo\'lishi yoki tarmoqda muammo bo\'lishi mumkin. Bir ozdan keyin javob berishi mumkin.',
    device_stale_badge: 'Javob bermayapti',
    device_stale_transition: 'Qurilma anchadan beri aloqaga chiqmadi - uning haqiqiy holati noaniq. Quyida amalni tanlang, u qurilma qayta ulanganda bajariladi.',
    date: 'Sana',
    time: 'Vaqt',
